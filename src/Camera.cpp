...
{
  matrix_ = glm::translate(matrix_, glm::vec3(-0.05f, 0.0f, 0.0f));
}
...
void Camera::moveUp()
{
  matrix_ = glm::translate(matrix_, glm::vec3(0.0f, -0.05f, 0.0f));
}
...
{
  matrix_ = glm::translate(matrix_, glm::vec3(0.0f, 0.0f, 0.05f));
}
